...
# 第九题
输出n以内的[完美数](https://baike.baidu.com/item/%E5%AE%8C%E5%85%A8%E6%95%B0/370913?fromtitle=%E5%AE%8C%E7%BE%8E%E6%95%B0&fromid=871560)
可能的函数原型：
```
...
写一个方法，方法给定一个参数 n ，利用 n 个符号 * 打印一个沙漏。
例如：给定 n = 17 ，则打印出来的沙漏如下
```
*****
 ***
  *
...
注意：
- 推荐使用[冒泡排序](https://zh.wikipedia.org/wiki/%E5%86%92%E6%B3%A1%E6%8E%92%E5%BA%8F)完成,当然使用其他的排序方式也是welcome的
- 推荐使用[结构体](https://zh.wikipedia.org/wiki/%E7%BB%93%E6%9E%84%E4%BD%93_(C%E8%AF%AD%E8%A8%80))完成这个问题
- 可以使用Java完成 
- 可以使用多余的空间储存
